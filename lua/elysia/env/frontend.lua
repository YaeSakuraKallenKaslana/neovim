...
return function(config)
  return {
    ...
    getLSPConfigMap = function()
      local list = {
        tsserver = require("elysia.lsp.config.typescript"),
        cssls = require("elysia.lsp.config.css"),
        emmet_ls = require("elysia.lsp.config.emmet"),
        html = require("elysia.lsp.config.html"),
      }
      if config.tailwindcss then
        list.tailwindcss = require("elysia.lsp.config.tailwindcss")
      end
      if config.vue then
        list.volar = require("elysia.lsp.config.volar")
      end
      if config.prisma then
        list.prismals = require("elysia.lsp.config.prismals")
      end
