...
mason_config.setup({
  ensure_installed = require("elysia.env").getLSPEnsureList(),
})

mason_tool.setup({
  ensure_installed = require("elysia.env").getToolEnsureList(),
})

local servers = require("elysia.env").getLSPConfigMap()
