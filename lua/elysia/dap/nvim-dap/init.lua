...
if dap and dapui and vt then
  local cfg = require("elysia").config
  require("elysia.dap.nvim-dap.ui")
  ...
  if cfg.lua and cfg.lua.enable then
    require("elysia.dap.nvim-dap.config.lua").setup()
  end
  ...
  --   require("elysia.dap.nvim-dap.config.cpp").setup()
  -- end

  if cfg.frontend and cfg.frontend.enable then
    require("elysia.dap.nvim-dap.config.vscode-js")
  end

  require("elysia.dap.nvim-dap.common-config").keyAttach()
end
